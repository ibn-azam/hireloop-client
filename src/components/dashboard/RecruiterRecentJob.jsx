...
export function RecruiterRecentJob() {
  return (
    <div className="w-full max-w-4xl my-6 text-white ">
      {/* Header section */}
      ...
      {/* Table section */}
      <Table className="border rounded-xl border-[#444748]">
            ...
            <Table.Header className="sticky top-0 z-10 bg-surface-secondary mb-2">
              {columns.map((col) => (
                <Table.Column 
                  ...
                  className="text-gray-400 font-medium py-4 text-left border-b border-[#444748]"
                >
                  {col.name}
                </Table.Column>
              ))}
